...
E[C] = 1/2 Statement coverage + 1/2 Branch coverage
...
def train_on_ds7():
    ...
    reg = Regression(df_path=r'dataset07/DS07610.csv')
    reg.regress(model_path=r'sklearn_models7/DTR1_DS6.joblib', model_number=1)
    reg.regress(model_path=r'sklearn_models7/RFR1_DS6.joblib', model_number=2)
    reg.regress(model_path=r'sklearn_models7/GBR1_DS1.joblib', model_number=3)
    reg.regress(model_path=r'sklearn_models7/HGBR1_DS6.joblib', model_number=4)
    reg.regress(model_path=r'sklearn_models7/SGDR1_DS6.joblib', model_number=5)
    reg.regress(model_path=r'sklearn_models7/MLPR1_DS6.joblib', model_number=6)
    reg.vote(model_path=r'sklearn_models7/VR1_DS6.joblib', dataset_number=6)
...
def main():
    train_on_ds7()  # Last train is performed on important testability metric, DS#6
