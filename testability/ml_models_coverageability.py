...
class Regression(object):
    def __init__(self, df_path=r'dataset06/DS06013.csv', avg_type=None):
        ...
        self.X_train1, self.X_test1, self.y_train, self.y_test = train_test_split(self.df.iloc[:, 1:-5],
                                                                                  # self.df.iloc[:, -2],
    ...
    def inference_model2(self, model=None, model_path=None, predict_data_path=None):
        ...
        df_new['PredictedCoverageability'] = list(y_pred)
        print(df_new)
    ...
    def vote(self, model_path=None, dataset_number=1):
        # Trained regressors
        reg1 = load(r'sklearn_models6c/coveragability_arithmetic_mean/HGBR6_DS{0}.joblib'.format(dataset_number))
        reg2 = load(r'sklearn_models6c/coveragability_arithmetic_mean/RFR6_DS{0}.joblib'.format(dataset_number))
        reg3 = load(r'sklearn_models6c/coveragability_arithmetic_mean/MLPR6_DS{0}.joblib'.format(dataset_number))
